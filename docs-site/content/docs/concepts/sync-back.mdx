...
- [Workspaces](/docs/concepts/workspaces) - Upload and cloud persistence
- [catty download](/docs/cli/download) - Download on demand
- [catty sync](/docs/cli/sync) - Sync on demand
