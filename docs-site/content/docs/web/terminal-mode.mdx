...
Tap the chat icon in the header to switch to [Chat Mode](/docs/web/chat-mode). Both modes connect to the same session - switching doesn't interrupt your work.
