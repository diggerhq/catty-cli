...
See [GitHub Integration](/docs/concepts/github) for details.
...
- [Secrets](/docs/concepts/secrets) - How secrets work, encryption details
- [GitHub Integration](/docs/concepts/github) - Set up GitHub access for Claude
- [catty new](/docs/cli/new) - Start session with secrets
