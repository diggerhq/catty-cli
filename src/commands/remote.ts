// This is the original "catty new" command - creates cloud sessions
// Renamed to "catty remote" to make local sessions the default
...
export const remoteCommand = new Command('remote')
  .description('Start a new cloud session (runs on remote server)')
  ...
  .action(async function (this: Command) {
    ...
    console.log('☁️  Creating cloud session...');
